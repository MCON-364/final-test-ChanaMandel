...
public class ProductReviewAnalyzer {
    ...
    public ProductReviewAnalyzer(List<String> categories) {
      //TODO - implement this constructor
        this.categories = List.copyOf(Objects.requireNonNull(categories, "categories list cannot be null"));
    }
    ...
    public List<String> getTopNCategories(int n) {
        ...
        Map<String, Long> topNCategories = buildCategoryFrequencyMap();
        return topNCategories.entrySet().stream()
    ...
    public List<String> getCategoriesStartingWith(char prefix) {
        //TODO - implement this method
        TreeMap<String, Long> startsWith = buildCategoryFrequencyMap();
        String startChar = String.valueOf(prefix);
        String endChar = String.valueOf((char) (prefix + 1));

        return startsWith.subMap(startChar, true, endChar, false)
                .keySet()
                .stream()
                .toList();
    }
